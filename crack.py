...
if __name__ == '__main__':
    ...
    usernames = ['corum', 'runner', 'edwards','dev_admin','www-data']
    modnames = ['flask.app', 'werkzeug.debug']
    appnames = ['wsgi_app', 'DebuggedApplication', 'Flask']
    flaskpaths = ['/app/venv/lib/python3.10/site-packages/flask/app.py', '/app/venv/lib/python3.10/site-packages/werkzeug/debug/__init__.py']
    nodeuuids = ['345052362183']
    machineids = ['ed5b159560f54721827644bc9b220d00', 'ed5b159560f54721827644bc9b220d001ed5fe3e-9fca-43d8-b697-49e7860c37de', 'ed5b159560f54721827644bc9b220d001ed5fe3e-9fca-43d8-b697-49e7860c37desuperpass.service', 'ed5b159560f54721827644bc9b220d00superpass.service']
